...
Usage
-----
    from ecdysis.harness.skills import retrieve_skills, format_skills_block, DOMAIN_SKILLS
...
def retrieve_skills(
    ...
    Args:
        ...
        extra_skills: Optional evolved skills loaded from experiment artifacts.
            These are appended to the domain library for this retrieval call
            without mutating the static global skill lists.
    ...
    if extra_skills:
        skills_list = list(skills_list) + list(extra_skills)
        token_lists = [_tokenize(s.pattern) for s in skills_list]
